...
async def watch_groups_loop():
    ...
    while True:
        try:
            # MUHIM: avval bu yerda "scanning_enabled" tekshiruvi yo'q
            # edi - shuning uchun admin paneldagi "Avtomatik skanerlashni
            # to'xtatish" tugmasi xona/o'qituvchi/guruh havolalari
            # skanerlashini to'xtatsa ham, BU kuzatuvchi baribir ishlab
            # turaverar edi (har kuni BARCHA "Mening guruhim" belgilagan
            # foydalanuvchilar sonicha TSUE saytiga so'rov yuborib).
            # Endi bitta tugma HAMMA fon skanerlashni birdek
            # to'xtatadi/yoqadi.
